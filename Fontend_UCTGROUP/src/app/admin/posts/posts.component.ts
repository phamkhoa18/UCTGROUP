...
export class PostsComponent {
  ...
  constructor(private api : ApiService, private router : Router , private dataadminservice : DataAdminService){
    ...
    return new Promise<void>(async (resolve, reject) => {
      (await this.api.get('/listnew')).subscribe(
        (v: any) => {
          ...
          this.listbaiviet$.subscribe(v => this.listbaiviet = v );
  ...
  edit(item : any) {
    this.dataadminservice.isItem = item ;
